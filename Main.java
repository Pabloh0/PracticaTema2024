                ...
                case 1: //VENDE ENTRADAS
                    ...
                    if (op >= 1 && op <= 3) {//Si el usuario no le da a salir se mostrara el menu para elegir asiento
                        ...
                        if (sitioElegido >= 1 && sitioElegido <= 3) {//Si el usuario no le da a salir se preguntara la cantidad de entradas y fecha.
                            switch (op) {
                                case 1://Se hace la logica de comprar entradas para la opcion seleccionada.
                                    ...
                                    if (entraTotaCri <= 0)//Comprobación para saber si quedan entradas de cualquier tipo
                                        ...
                                        System.out.print("Cuntas entradas van a ser: ");
                            ...
                            if (cantEntraCompradas > entraPlaCri || cantEntraCompradas > entraPlaConJa || cantEntraCompradas > entraPlaConO) cantEntraCompradas = 0;
                            if (cantEntraCompradas > entraBuCri || cantEntraCompradas > entraBuConJa || cantEntraCompradas > entraBuConO) cantEntraCompradas = 0;
                            if (cantEntraCompradas > entraAnfCri || cantEntraCompradas > entraAnfConJa || cantEntraCompradas > entraAnfConO) cantEntraCompradas = 0;
